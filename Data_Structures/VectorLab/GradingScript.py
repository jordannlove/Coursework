...
def compileStudentCpp(stu_cpp_file,stu_output_name,inputfoler_name):
    ...
    stu_file = "g++ -std=c++11 "+str(stu_cpp_file)+" -o Stu_Lab1 >/dev/null 2>&1"
    ...
    if flag ==0 :
        ...
        print("Please make sure your header type")
        sys.exit()
        return False
...
if __name__ == '__main__':
    ...
    if((foldername)=="" or (headername)=="" or outputname==""):
        ...
        if(os.path.exists(headername)):
            ...
            header_rename = "cp " +(headername)+ " myVector.h >/dev/null 2>&1"
